...
```sh
npx --yes @tarileo/avileo-catalog-cli@0.2.2 catalog asset list --json
npx --yes @tarileo/avileo-catalog-cli@0.2.2 catalog asset get <asset-id> --json
```
...
```sh
npx --yes @tarileo/avileo-catalog-cli@0.2.2 catalog asset upload --file image.png --json
npx --yes @tarileo/avileo-catalog-cli@0.2.2 catalog asset upload --file image.png --apply --json
```
...
```sh
npx --yes @tarileo/avileo-catalog-cli@0.2.2 catalog asset import-url --from image-source.json --json
npx --yes @tarileo/avileo-catalog-cli@0.2.2 catalog asset import-url --from image-source.json --apply --json
```
