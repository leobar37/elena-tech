...
```sh
npx --yes @tarileo/avileo-catalog-cli@0.1.4 catalog inventory get <variant-id> --json
npx --yes @tarileo/avileo-catalog-cli@0.1.4 catalog inventory movements <variant-id> --json
```
...
```sh
npx --yes @tarileo/avileo-catalog-cli@0.1.4 catalog inventory adjust <variant-id> --from adjustment.json --json
npx --yes @tarileo/avileo-catalog-cli@0.1.4 catalog inventory adjust <variant-id> --from adjustment.json --apply --json
npx --yes @tarileo/avileo-catalog-cli@0.1.4 catalog inventory set <variant-id> --from inventory-set.json --json
npx --yes @tarileo/avileo-catalog-cli@0.1.4 catalog inventory set <variant-id> --from inventory-set.json --apply --json
```
